<template>
  ...
  >
    <h1
      class="text-c-1 text-center text-pretty text-style-not-big md:w-1/2 mx-4 md:mb-24 mb-12 font-black italic"
    >
      {{ currentProject.fullTitle.toUpperCase() }}
    </h1>
  </div>
  <article
    class="px-4 sm:px-8 md:px-12 flex flex-col text-center my-24 gap-12 md:gap-24"
  >
  ...
  <div
    class="flex items-center px-4 sm:px-8 md:px-12 mb-24 gap-12 md:gap-36"
    :class="
      currentProject.aspectRatio === '16/9'
        ? 'flex-col-reverse'
