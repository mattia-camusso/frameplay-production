    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Frameplay P.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Frameplay Production, accessible
          from
          <a
            href="https://frameplayvideo.com"
            rel="external nofollow noopener"
            target="_blank"
            >https://frameplayvideo.com</a
          >
        </p>
      </li>
      <li>
